export const GENERAL_QUESTION = [
  '“Social Change, Arrange The World มิติใหม่เว็บสร้างสังคม” สำหรับน้อง ๆ หมายความว่าอย่างไร',
  'หากน้อง ๆ มีอำนาจพอที่จะสามารถเปลี่ยนแปลงสังคมได้ 1 สิ่ง จะเลือกเปลี่ยนแปลงอะไรก่อน และจะเลือกเปลี่ยนแปลงด้วยวิธีการใด เพราะเหตุใด',
  'น้อง ๆ คาดหวังอะไรจากการเข้าค่าย YWC17 ในปีนี้'
]
...
export const MAJOR_QUESTION = (major: string) => {
  switch (major) {
    case 'content':
      return [
        'ให้น้องเขียน Fake News หรือ Fake Content เรื่องอะไรก็ได้ ที่ทำให้กรรมการอ่านแล้วรู้สึกเชื่อจนเผลอแชร์ก่อนเช็ก (ส่งคอนเทนต์นี้ในเว็บค่ายเท่านั้น ห้ามเผยแพร่คอนเทนต์ออกไปในโซเชียล)',
    ...
    case 'design':
      return [
        ...
        'Portfolio; ผลงานของคุณที่เกี่ยวข้องด้าน UX/UI (ไฟล์ PDF ขนาดไม่เกิน 50 MB)'
      ]
    case 'marketing':
      return [
        'จงบอก จุดแข็ง (อย่างน้อย 2 ข้อ) และ จุดอ่อน (อย่างน้อย 2 ข้อ) ของสื่อประเภทเว็บไซต์ สำหรับตัวเรา แบรนด์ และธุรกิจ เมื่อเทียบกับสื่อดิจิทัล ประเภทอื่น ๆ เช่น โมบายแอปพลิเคชันและโซเชียลมีเดีย เป็นต้น',
        'คุณคิดว่าการทำ Marketing กับ Content เหมือนหรือต่างกันอย่างไร และอะไรคือเรื่องที่สำคัญที่สุดของการทำการตลาด'
      ]
    case 'programming':
      return [
        'ให้น้องเล่าประสบการณ์การทำงานเกี่ยวกับการทำหรือพัฒนาเว็บไซต์ (สามารถแปะลิงก์ผลงานที่เคยทำไว้ได้)',
...
export const DEADLINE = '2019/10/15'
